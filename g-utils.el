...
(defun g--clean-string (s)
  (g--replace-list-of-pairs s
                            '(("\n" . "")
                              (" +" . " "))
                            ))

(defun g--c-defun-params ()    ;; output is list
  (save-excursion
    (beginning-of-defun)  ;; assume point in defun
...
(defun g--c-invocation-params-string ()
  (g--replace-list-of-pairs
...
(defun g--c-invocation-params ()
  (g--split-params-string (g--c-invocation-params-string)))
